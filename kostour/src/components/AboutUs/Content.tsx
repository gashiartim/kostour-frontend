  ...
  return (
    <div className="container mt-[112px] text-gray-500 w-full lg:px-[185px]">
        ...
        <div>
            ...
            />
            <h1 className="text-3xl text-white pb-[10px] mt-9 font-bold text-center md:text-left">Full of forest</h1>
        ...
        <div>
            ...
            />
            <h1 className="text-3xl text-white pb-[10px] mt-9 font-bold text-center md:text-left">Visa Free</h1>
        ...
        <div>
            ...
            className="inline pb-[31px] mx-[px] sm:mx-[300px] md:mx-0"
            /> 
            <h1 className="text-3xl text-white pb-[10px] mt-9 font-bold text-center md:text-left">Perfect Climate</h1>
        ...
        <div>
            ...
            />
            <h1 className="text-3xl text-white pb-[10px] mt-9 font-bold text-center md:text-left">Young People</h1>
