...
const Details = (props: Props) => {
  ...
  return (
    <div className="relative lg:mt-[425px] -mt-[30px] p-5 lg:p-0">
      <div className="lg:absolute lg:bottom-[250px] ">
        ...
        {open_hours && (
          <div className="mr-[80px] mt-[15px] text-lg">
            <span className="mr-2 font-light text-white">Open Hours:</span>
            <span className="font-medium text-white"> {open_hours}</span>
          </div>
        )}
